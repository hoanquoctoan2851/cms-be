...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteChangeCourseLetter = exports.updateChangeCourseLetter = exports.detailChangeCourseLetter = exports.getChangeCourseLetterByUserId = exports.createChangeCourse = void 0;
...
// Đơn hủy học phần
function createChangeCourse(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield changeCourse_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
...
exports.createChangeCourse = createChangeCourse;
function getChangeCourseLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("changeCourse");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getChangeCourseLetterByUserId = getChangeCourseLetterByUserId;
function detailChangeCourseLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield changeCourse_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailChangeCourseLetter = detailChangeCourseLetter;
function updateChangeCourseLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield changeCourse_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateChangeCourseLetter = updateChangeCourseLetter;
function deleteChangeCourseLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield changeCourse_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
...
exports.deleteChangeCourseLetter = deleteChangeCourseLetter;
