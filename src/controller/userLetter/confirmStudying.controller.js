...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteConfirmStudyingLetter = exports.updateConfirmStudyingLetter = exports.detailConfirmStudyingLetter = exports.getConfirmStudyingLetterByUserId = exports.createConfirmStudyingLetter = void 0;
...
exports.createConfirmStudyingLetter = createConfirmStudyingLetter;
function getConfirmStudyingLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("confirmStudying");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getConfirmStudyingLetterByUserId = getConfirmStudyingLetterByUserId;
function detailConfirmStudyingLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield confirmStudying_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailConfirmStudyingLetter = detailConfirmStudyingLetter;
function updateConfirmStudyingLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield confirmStudying_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateConfirmStudyingLetter = updateConfirmStudyingLetter;
function deleteConfirmStudyingLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield confirmStudying_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
