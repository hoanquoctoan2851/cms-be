...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteResolveWorkLetter = exports.updateResolveWorkLetter = exports.detailResolveWorkLetter = exports.getResolveWorkByUserId = exports.createResolveWorkLetter = void 0;
...
function createResolveWorkLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield resolveWork_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
                yield userLetter_model_1.default.findOneAndUpdate({ user: user._id }, {
                    user: user,
                    $push: { resolveWork: newLetter._id },
                }, {
                    new: true,
                    upsert: true,
                });
...
exports.createResolveWorkLetter = createResolveWorkLetter;
function getResolveWorkByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("resolveWork");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getResolveWorkByUserId = getResolveWorkByUserId;
function detailResolveWorkLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield resolveWork_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailResolveWorkLetter = detailResolveWorkLetter;
function updateResolveWorkLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield resolveWork_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateResolveWorkLetter = updateResolveWorkLetter;
function deleteResolveWorkLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield resolveWork_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
...
exports.deleteResolveWorkLetter = deleteResolveWorkLetter;
