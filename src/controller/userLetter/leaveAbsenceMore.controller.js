...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteLeaveAbsenceMoreLetter = exports.updateLeaveAbsenceMoreLetter = exports.detailLeaveAbsenceMoreLetter = exports.getLeaveAbsenceMoreLetterByUserId = exports.createLeaveAbsenceMoreLetter = void 0;
...
// Đơn hủy học phần
function createLeaveAbsenceMoreLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield leaveAbsenceMore_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
                yield userLetter_model_1.default.findOneAndUpdate({ user: user._id }, {
                    user: user,
                    $push: { leaveAbsenceMore: newLetter._id },
                }, {
                    new: true,
                    upsert: true,
                });
...
exports.createLeaveAbsenceMoreLetter = createLeaveAbsenceMoreLetter;
function getLeaveAbsenceMoreLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("leaveAbsenceMore");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getLeaveAbsenceMoreLetterByUserId = getLeaveAbsenceMoreLetterByUserId;
function detailLeaveAbsenceMoreLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield leaveAbsenceMore_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailLeaveAbsenceMoreLetter = detailLeaveAbsenceMoreLetter;
function updateLeaveAbsenceMoreLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield leaveAbsenceMore_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateLeaveAbsenceMoreLetter = updateLeaveAbsenceMoreLetter;
function deleteLeaveAbsenceMoreLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield leaveAbsenceMore_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
            ...
            const userLetter = yield userLetter_model_1.default.findOneAndUpdate({
                leaveAbsenceMore: letter,
            }, {
                $pull: { leaveAbsenceMore: id },
            }, {
                new: true,
                upsert: true,
            });
...
exports.deleteLeaveAbsenceMoreLetter = deleteLeaveAbsenceMoreLetter;
