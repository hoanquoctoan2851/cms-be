...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteConfirmStudyingLetter = exports.updateCancelCourseLetter = exports.detailCancelCourseLetter = exports.getCancelCourseLetterByUserId = exports.createCancelCourseLetter = void 0;
...
// Đơn hủy học phần
function createCancelCourseLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield cancelCourse_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
                ...
                if (isBalanceDecreased) {
                    yield userLetter_model_1.default.findOneAndUpdate({ user: user._id }, {
                        user: user,
                        $push: { cancelCourse: newLetter._id },
                    }, {
                        new: true,
                        upsert: true,
                    });
                    ...
                    yield cancelCourse_model_1.default.findByIdAndDelete(newLetter._id);
...
exports.createCancelCourseLetter = createCancelCourseLetter;
function getCancelCourseLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("cancelCourse");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getCancelCourseLetterByUserId = getCancelCourseLetterByUserId;
function detailCancelCourseLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield cancelCourse_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailCancelCourseLetter = detailCancelCourseLetter;
function updateCancelCourseLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield cancelCourse_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateCancelCourseLetter = updateCancelCourseLetter;
function deleteConfirmStudyingLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield cancelCourse_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
...
exports.deleteConfirmStudyingLetter = deleteConfirmStudyingLetter;
