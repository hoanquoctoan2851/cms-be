...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteLeaveAbsenceLessLetter = exports.updateLeaveAbsenceLessLetter = exports.detailLeaveAbsenceLessLetter = exports.getLeaveAbsenceLessLetterByUserId = exports.createLeaveAbsenceLessLetter = void 0;
...
// Đơn hủy học phần
function createLeaveAbsenceLessLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield leaveAbsenceLess_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
...
exports.createLeaveAbsenceLessLetter = createLeaveAbsenceLessLetter;
function getLeaveAbsenceLessLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("leaveAbsenceLess");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getLeaveAbsenceLessLetterByUserId = getLeaveAbsenceLessLetterByUserId;
function detailLeaveAbsenceLessLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield leaveAbsenceLess_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailLeaveAbsenceLessLetter = detailLeaveAbsenceLessLetter;
function updateLeaveAbsenceLessLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield leaveAbsenceLess_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateLeaveAbsenceLessLetter = updateLeaveAbsenceLessLetter;
function deleteLeaveAbsenceLessLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield leaveAbsenceLess_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
...
exports.deleteLeaveAbsenceLessLetter = deleteLeaveAbsenceLessLetter;
