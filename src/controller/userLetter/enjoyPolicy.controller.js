...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteEnjoyPolicyLetter = exports.detailEnjoyPolicyLetter = exports.updateEnjoyPolicyLetter = exports.getEnjoyPolicyLetterByUserId = exports.createEnjoyPolicyLetter = void 0;
...
function createEnjoyPolicyLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield enjoyPolicy_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
...
exports.createEnjoyPolicyLetter = createEnjoyPolicyLetter;
function getEnjoyPolicyLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("enjoyPolicy");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getEnjoyPolicyLetterByUserId = getEnjoyPolicyLetterByUserId;
function updateEnjoyPolicyLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield enjoyPolicy_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateEnjoyPolicyLetter = updateEnjoyPolicyLetter;
function detailEnjoyPolicyLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield enjoyPolicy_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailEnjoyPolicyLetter = detailEnjoyPolicyLetter;
function deleteEnjoyPolicyLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield enjoyPolicy_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
...
exports.deleteEnjoyPolicyLetter = deleteEnjoyPolicyLetter;
