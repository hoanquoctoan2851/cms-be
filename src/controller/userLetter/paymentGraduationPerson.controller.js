...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deletePaymentGraduationPersonLetter = exports.updatePaymentGraduationPersonLetter = exports.detailPaymentGraduationPersonLetter = exports.getPaymentGraduationPersonLetterByUserId = exports.createPaymentGraduationPerson = void 0;
...
// Đơn hủy học phần
function createPaymentGraduationPerson(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield paymentGraduationPerson_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
...
exports.createPaymentGraduationPerson = createPaymentGraduationPerson;
function getPaymentGraduationPersonLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("paymentGraduationPerson");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getPaymentGraduationPersonLetterByUserId = getPaymentGraduationPersonLetterByUserId;
function detailPaymentGraduationPersonLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield paymentGraduationPerson_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailPaymentGraduationPersonLetter = detailPaymentGraduationPersonLetter;
function updatePaymentGraduationPersonLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield paymentGraduationPerson_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updatePaymentGraduationPersonLetter = updatePaymentGraduationPersonLetter;
function deletePaymentGraduationPersonLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield paymentGraduationPerson_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
...
exports.deletePaymentGraduationPersonLetter = deletePaymentGraduationPersonLetter;
