...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteReservationAcademicLetter = exports.updateReservationAcademicLetter = exports.detailReservationAcademicLetter = exports.getReservationAcademicByUserId = exports.createReservationAcademicLetter = void 0;
...
function createReservationAcademicLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield reservationAcademic_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
                yield userLetter_model_1.default.findOneAndUpdate({ user: user._id }, {
                    user: user,
                    $push: { reservationAcademic: newLetter._id },
                }, {
                    new: true,
                    upsert: true,
                });
...
exports.createReservationAcademicLetter = createReservationAcademicLetter;
function getReservationAcademicByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("reservationAcademic");
            if (!letter) {
                return res.send({
                    success: false,
            ...
            return res.send({
                success: true,
                data: letter.reservationAcademic,
            });
        }
        catch (error) {
            return res.status(500).send({
...
exports.getReservationAcademicByUserId = getReservationAcademicByUserId;
function detailReservationAcademicLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield reservationAcademic_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailReservationAcademicLetter = detailReservationAcademicLetter;
function updateReservationAcademicLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield reservationAcademic_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateReservationAcademicLetter = updateReservationAcademicLetter;
function deleteReservationAcademicLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield reservationAcademic_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
            ...
            const userLetter = yield userLetter_model_1.default.findOneAndUpdate({
                reservationAcademic: letter,
            }, {
                $pull: { reservationAcademic: id },
            }, {
                new: true,
                upsert: true,
            });
...
exports.deleteReservationAcademicLetter = deleteReservationAcademicLetter;
