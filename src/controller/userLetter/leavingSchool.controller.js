...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteLeavingSchoolLetter = exports.updateLeavingSchoolLetter = exports.detailLeavingSchoolLetter = exports.getLeavingSchoolLetterByUserId = exports.createLeavingSchoolLetter = void 0;
...
// Đơn hủy học phần
function createLeavingSchoolLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield leavingSchool_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
...
exports.createLeavingSchoolLetter = createLeavingSchoolLetter;
function getLeavingSchoolLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("leavingSchool");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getLeavingSchoolLetterByUserId = getLeavingSchoolLetterByUserId;
function detailLeavingSchoolLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield leavingSchool_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailLeavingSchoolLetter = detailLeavingSchoolLetter;
function updateLeavingSchoolLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield leavingSchool_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateLeavingSchoolLetter = updateLeavingSchoolLetter;
function deleteLeavingSchoolLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield leavingSchool_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
...
exports.deleteLeavingSchoolLetter = deleteLeavingSchoolLetter;
