...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteBankLoanLetter = exports.updateBankLoanLetter = exports.detailBankLoanLetter = exports.getBankLoanLetterByUserId = exports.createBankLoanLetter = void 0;
...
function createBankLoanLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield bankLoan_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
                ...
                if (isBalanceDecreased) {
                    ...
                    yield bankLoan_model_1.default.findByIdAndDelete(newLetter._id);
...
exports.createBankLoanLetter = createBankLoanLetter;
function getBankLoanLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("bankLoan");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getBankLoanLetterByUserId = getBankLoanLetterByUserId;
function detailBankLoanLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield bankLoan_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailBankLoanLetter = detailBankLoanLetter;
function updateBankLoanLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield bankLoan_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateBankLoanLetter = updateBankLoanLetter;
function deleteBankLoanLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield bankLoan_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
...
exports.deleteBankLoanLetter = deleteBankLoanLetter;
