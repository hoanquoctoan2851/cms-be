...
exports.verifyCodeLetter = exports.getCodeLetter = exports.deleteRenewStudentCardLetter = exports.updateRenewStudentCardLetter = exports.detailRenewStudentCardLetter = exports.getRenewStudentCardLetterByUserId = exports.createRenewStudentCardLetter = void 0;
...
function createRenewStudentCardLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            const newLetter = yield renewStudentCard_model_1.default.create(Object.assign(Object.assign({}, req.body), { hashCode: codeOtp.hashedOtp }));
            if (newLetter) {
                yield userLetter_model_1.default.findOneAndUpdate({ user: user._id }, {
                    user: user,
                    $push: { renewStudentCard: newLetter._id },
                }, {
                    new: true,
                    upsert: true,
                });
...
exports.createRenewStudentCardLetter = createRenewStudentCardLetter;
function getRenewStudentCardLetterByUserId(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id: userId } = req.params;
            const letter = yield userLetter_model_1.default.findOne({ user: userId }).populate("renewStudentCard");
            if (!letter) {
                return res.send({
                    success: false,
...
exports.getRenewStudentCardLetterByUserId = getRenewStudentCardLetterByUserId;
function detailRenewStudentCardLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            const { id } = req.params;
            const data = yield renewStudentCard_model_1.default.findById(id);
            return res.send({
                success: true,
                data: data,
            });
...
exports.detailRenewStudentCardLetter = detailRenewStudentCardLetter;
function updateRenewStudentCardLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        const letter = yield renewStudentCard_model_1.default.findByIdAndUpdate(id, req.body, {
            new: true,
            upsert: true,
        });
        return res.send({
...
exports.updateRenewStudentCardLetter = updateRenewStudentCardLetter;
function deleteRenewStudentCardLetter(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        const { id } = req.params;
        try {
            const letter = yield renewStudentCard_model_1.default.findById(id);
            if (!letter) {
                return res.send({
                    success: false,
            ...
            const userLetter = yield userLetter_model_1.default.findOneAndUpdate({
                renewStudentCard: letter,
            }, {
                $pull: { renewStudentCard: id },
            }, {
                new: true,
                upsert: true,
            });
...
exports.deleteRenewStudentCardLetter = deleteRenewStudentCardLetter;
