...
exports.createLeaveAbsenceLessSchema = void 0;
const zod_1 = __importStar(require("zod"));
const regex_1 = require("../../utils/regex");
exports.createLeaveAbsenceLessSchema = (0, zod_1.object)({
    body: (0, zod_1.object)({
        msv: (0, zod_1.string)({
            required_error: "Msv is required",
        }),
        classCourse: (0, zod_1.string)({
            required_error: "Class course is required",
        }),
        name: (0, zod_1.string)({
        ...
        timeLeave: (0, zod_1.array)((0, zod_1.string)().refine((val) => regex_1.regexDate.test(val), {
