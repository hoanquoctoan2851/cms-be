...
exports.createLeavingSchoolSchema = void 0;
const zod_1 = __importStar(require("zod"));
const regex_1 = require("../../utils/regex");
exports.createLeavingSchoolSchema = (0, zod_1.object)({
    body: (0, zod_1.object)({
        msv: (0, zod_1.string)({
        ...
        dateLeave: (0, zod_1.string)().refine((val) => regex_1.regexDate.test(val), {
