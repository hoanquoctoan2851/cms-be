...
exports.createReservationAcademicSchema = void 0;
const zod_1 = __importStar(require("zod"));
const regex_1 = require("../../utils/regex");
exports.createReservationAcademicSchema = (0, zod_1.object)({
    body: (0, zod_1.object)({
        msv: (0, zod_1.string)({
        ...
        parentName: (0, zod_1.string)({
            required_error: "Parent name is required",
        }),
        parentPhone: (0, zod_1.string)({
            required_error: "Parent phone is required",
        }),
        address: (0, zod_1.string)({
            required_error: "Address is required",
        }),
        timeStartReservation: (0, zod_1.string)({
            required_error: "Time start reservation required",
        }).refine((val) => regex_1.regexDate.test(val), {
            message: "Time start reservation is type YYYY-MM-DD",
        }),
        ...
        timeReservation: (0, zod_1.number)({
            required_error: "Time reservation is required",
        }),
